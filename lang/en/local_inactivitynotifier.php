...
$string['messageprovider:inactivity_notification'] = 'Inactivity notification';
...
$string['privacy:metadata'] = 'The Inactivity Notifier logs sent notifications in order to prevent sending duplicate notifications too frequently.';
$string['privacy:metadata:courseid'] = 'The ID of the course in which the user was inactive.';
$string['privacy:metadata:tableexplanation'] = 'This table stores logs of inactivity notifications sent to prevent spamming students.';
$string['privacy:metadata:timesent'] = 'The timestamp of when the notification was sent.';
$string['privacy:metadata:userid'] = 'The ID of the user who received a notification.';
...
$string['setting_excluded_categories'] = 'Excluded categories';
$string['setting_excluded_categories_desc'] = 'Comma-separated list of course category IDs to exclude from notifications.';
$string['setting_excluded_courses'] = 'Excluded courses';
$string['setting_excluded_courses_desc'] = 'Comma-separated list of course IDs to exclude from notifications (e.g. 12,34,56).';
...
$string['setting_remind_frequency'] = 'Remind frequency';
$string['setting_remind_frequency_desc'] = 'Minimum number of days to wait before sending another inactivity notification to the same student in the same course.';
